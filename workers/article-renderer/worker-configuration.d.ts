/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts` (hash: 2bac5b34d2e3b0bdfea748971e673d4b)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		GITHUB_REGISTRY: D1Database;
		ARTICLE_RENDER_QUEUE: Queue;
		GITHUB_APP_ID: string;
		GITHUB_PRIVATE_KEY: string;
		REPO_SYNC_STATE: DurableObjectNamespace /* RepoSyncState from hosonan-github-webhook */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GITHUB_APP_ID" | "GITHUB_PRIVATE_KEY">> {}
}
