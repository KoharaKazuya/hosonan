/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts` (hash: c0e8eae1785bb169c052d6d45710cb78)
// Runtime types generated with workerd@1.20260430.1 2026-05-03 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "RepoSyncState";
	}
	interface Env {
		GITHUB_REGISTRY: D1Database;
		ARTICLE_RENDER_QUEUE: Queue;
		WEBHOOK_SECRET: string;
		REPO_SYNC_STATE: DurableObjectNamespace<import("./src/worker").RepoSyncState>;
	}
}
